...
public class firstVoicemailExpandPlayPause {
    ...
    public void main() throws Exception {
        ...
        try{
            VoicemailAction.firstVoicemailExpandPlayPause();
            ExtentTestManager.getTest().log(Status.PASS, "Validate Deals Deeplink to a Product");
