package testcases.Voicemail;

import actions.VoicemailAction;
...
public class secondVoicemailCellExpandCollapse {
    ...
    public void main() throws Exception {
        ...
        try{
            VoicemailAction.secondVoicemailCellExpand();
            ExtentTestManager.getTest().log(Status.PASS, "Validate first Voicemail Cell Expand");
