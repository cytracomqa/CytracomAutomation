...
public class CallHistory_CallDetailsMessage {
    ...
    public void main() throws Exception {
        ...
        try{
            CallHistoryAction.CallDetailsMessage();
            ExtentTestManager.getTest().log(Status.PASS, "Search Results Validated from Deals page");
