package testcases.CallActive;

import actions.CallActiveAction;
...
public class CallActive_TransferCallButton {
    ...
    public void main() throws Exception {
        ...
        try{
            ...
            CallActiveAction.CallActiveTransferCallButton();
            ExtentTestManager.getTest().log(Status.PASS, "Active Call page Pause/Hold Button");
