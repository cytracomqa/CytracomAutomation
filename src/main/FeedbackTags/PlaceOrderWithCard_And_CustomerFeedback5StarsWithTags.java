package testcases.FeedbackTags;
...
public class PlaceOrderWithCard_And_CustomerFeedback5StarsWithTags {
    ...
    public void main() throws Exception {
        ...
        try{
            ...
            UpdateOrderStatus.UpdateOrder(iTestCaseRow);
            ExtentTestManager.getTest().log(Status.PASS, "Order Status moved to Delivered");

            // This Step is to submit Customer Feedback with tags
            FeedbackSubmission.FeedbackWithTags(iTestCaseRow);
            ExtentTestManager.getTest().log(Status.PASS, "Customer Feedback is submitted");
