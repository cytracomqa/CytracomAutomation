...
public class PlaceCAOrderWithCard_And_LineItemEdit {
    ...
    public void main() throws Exception {
        ...
        try{
            ...
            // This is to complete Line Item Edit
            LineItemEdit.LineItemE(iTestCaseRow);
            ExtentTestManager.getTest().log(Status.PASS, "Line Item Edit is done and Order is moved to Delivered");
