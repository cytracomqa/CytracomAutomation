package testcases.CanadaOrders;
...
public class PlaceCAOrderWithCard_And_CancelAfterReady {
    ...
    public void main() throws Exception {
        ...
        try{
            ...
            //if(iTestCaseRow==1)
            SignIn.SignInActionCA(iTestCaseRow);
            ...
            PlaceOrder.PlaceOrderAction(iTestCaseRow);
            ...
            UpdateOrderStatus.UpdateOrderToReady(iTestCaseRow);
            ExtentTestManager.getTest().log(Status.PASS, "Order Status moved to Ready");

            // This Step is to Cancel Order after it is moved to Ready Status
            //CancelOrderAction.CancelOrderPerform();
            CancelOrderAction.CancelOrderByAPI(iTestCaseRow);
            ExtentTestManager.getTest().log(Status.PASS, "Cancel Order is complete");

            //ZDriver = Utils.LaunchZD();
