...
public class PlaceCAOrderWithCard_And_CancelBeforeReady {
    ...
    public void main() throws Exception {
        ...
        try{
            ...
            UpdateOrderStatus.UpdateOrderToInProgress(iTestCaseRow);
            ExtentTestManager.getTest().log(Status.PASS, "Order Status moved to In Progress");

            // This Step is to Cancel Order after it is moved to In Progress Status
